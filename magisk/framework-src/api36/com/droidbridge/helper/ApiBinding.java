...
/** The API36 Binder declarations used by the fixed S-MAGISK-005 operations. */
final class ApiBinding implements PlatformBinding {
    ...
    private static final class Listener extends INotificationListener.Stub {
        ...
        @Override
        public void onNotificationPostedFull(StatusBarNotification sbn, NotificationRankingUpdate update) {
            sink.posted(sbn);
        }
        ...
        @Override
        public void onNotificationRemovedFull(StatusBarNotification sbn, NotificationRankingUpdate update, NotificationStats stats, int reason) {
            sink.removed(sbn);
        }
        ...
        @Override
        public void onNotificationEnqueuedWithChannelFull(StatusBarNotification sbn, NotificationChannel channel, NotificationRankingUpdate update) {
        ...
        @Override
        public void onNotificationSnoozedUntilContextFull(StatusBarNotification sbn, String snoozeCriterionId) {
