...
/** The API35 Binder declarations used by the fixed S-MAGISK-005 operations. */
final class ApiBinding implements PlatformBinding {
    ...
    public void sendAction(PendingIntent intent) throws PendingIntent.CanceledException {
        intent.send(ActivityOptions.makeBasic().setPendingIntentBackgroundActivityStartMode(ActivityOptions.MODE_BACKGROUND_ACTIVITY_START_ALLOWED).toBundle());
    }
