...
public interface IClipboard extends android.os.IInterface {
    void setPrimaryClip(android.content.ClipData clip, String callingPackage, int userId) throws android.os.RemoteException;
    void clearPrimaryClip(String callingPackage, int userId) throws android.os.RemoteException;
    android.content.ClipData getPrimaryClip(String pkg, int userId) throws android.os.RemoteException;
